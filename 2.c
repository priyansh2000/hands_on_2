...
/*
(base) priyansh@priyansh-ASUS-TUF-Gaming-A15-FA506II-FA506II:~/hands_on_2$ gcc -o 2op 2.c
(base) priyansh@priyansh-ASUS-TUF-Gaming-A15-FA506II-FA506II:~/hands_on_2$ ./2op
...
Max number of bytes of memory that may be locked into RAM - 
	Soft Limit: 962756608 bytes
	Hard Limit: 962756608 bytes
====================
...
Maximum  size of the process stack - 
	Soft Limit: 29087 bytes
	Hard Limit: 29087 bytes
====================
